      ...
      <div class="navbar-collapse">
        ...
        <ul class="navbar-nav my-lg-0">
                  ...
                  <div class="message-center">
                    ...
                    <a href="#">
                      ...
                      <div class="mail-contnet">
                        <h5>This is title</h5> <span class="mail-desc">Just see the my new admin!</span> <span
                    ...
                    <a href="#">
                      ...
                      <div class="mail-contnet">
                        <h5>This is another title</h5> <span
                    ...
                    <a href="#">
                      ...
                      <div class="mail-contnet">
                        <h5>This is title</h5> <span
                          class="mail-desc">You can customize this template as you want</span> <span class="time">9:08 AM</span>
                      </div>
                    </a>
                    <!-- Message -->
                    <a href="#">
                      ...
                      <div class="mail-contnet">
                        <h5>This is another title</h5> <span class="mail-desc">Just see the my admin!</span> <span
          ...
          <li
              ...
              @click="handleMessage"
          >
            <a class="nav-link dropdown-toggle text-muted  " href="#" id="2" data-toggle="dropdown" aria-haspopup="true"
              ...
              <ul>
                ...
                <li>
                  <div class="message-center">
                    <!-- Message -->
                    <a href="#">
                      <div class="user-img"><img src="../../images/users/5.jpg" alt="user" class="img-circle"> <span
                    ...
                    <a href="#">
                      ...
                      <div class="mail-contnet">
                        <h5>John Doe</h5> <span class="mail-desc">I've sung a song! See you at</span> <span
...
export default {
  ...
  methods: {
    ...
    onAsideTogglerClick () {
      const isOpen = this.isAsideOpen ? false : true
      this.setAsisdeVisibility(isOpen)
    }
  },
}
</script>
